...
MB_INFO = utility.MotherBoardInput('mother_board.png', '10&15data/25_chips/25_GCN_11.json').info_extraction()
RECT_LIST = MB_INFO[0]
print(len(RECT_LIST))
print(RECT_LIST)
...
def cost_func(path, cost_type, num_ground_truthes):
    ...
    if total < good_dis_perform:
        ...
        if num_ground_truthes < 10:
            ...
            name = 'ground_truth/ground_truth_'+str(int(total/10))+'0.yaml'
